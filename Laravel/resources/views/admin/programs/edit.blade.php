...
@section('content')
    ...
    @csrf
        ...
        @php
            $meals = ['صبحانه', 'ناهار', 'شام', 'میان‌وعده'];
            $selectedMeals = $program->required_meals ? json_decode($program->required_meals, true) : [];
        @endphp
        ...
        <div class="mb-2">
            ...
            @foreach ($meals as $meal)
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="meal_{{ $meal }}">
                        {{ $meal }}
                    </label>
                </div>
            @endforeach
        ...
        <div>
            ...
            @else
                <p class="text-muted">عکسی برای این برنامه ثبت نشده است.</p>
            @endif
